        ...
        <div className="skills__detail">
          <div className="skills__html-css">
            ...
            <ul>
              ...
              <li>
                I use CSS3, mainly Flexbox, to create responsive layouts that
              ...
              <li>
                I understand basic styling principles to make interfaces look
          ...
          <div className="skills__react">
            ...
            <ul>
              <li>
                I build React components using hooks like useState and
                useEffect.
              </li>
              <li>
